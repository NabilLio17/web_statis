  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-md-0">
        ...
        <!-- About link -->
        <li class="nav-item">
          <a class="nav-link" href="?page=about">Visi</a>
        </li>
        <!-- Contact link -->
        <li class="nav-item">
          <a class="nav-link" href="?page=contact">Misi</a>
        </li>
        <!-- Dropdown for "Belajar" -->
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="belajarDropdown" role="button"
            data-bs-toggle="dropdown" aria-expanded="false">
            info
          </a>
          <ul class="dropdown-menu" aria-labelledby="belajarDropdown">
            <li><a class="dropdown-item" href="?page=datatables">costumer</a></li>
